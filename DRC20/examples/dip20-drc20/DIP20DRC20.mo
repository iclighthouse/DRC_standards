...
shared(installMsg) actor class DIP20DRC20(initArgs: Types.InitArgs) = this {
    /*
    * Types 
    */
    ...
    * State Variables 
    */
    private stable var standard_: Text = "dip20; drc20"; 
    ...
    */
    ...
    // drc20 standard (extending compatibility interface).
